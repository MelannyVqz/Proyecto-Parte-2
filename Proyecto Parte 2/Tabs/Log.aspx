...
<asp:Label ID="cedulaLabel" Text="Cédula:" min="100000000" maxlength="9" AssociatedControlID="cedulalog" runat="server" 
               Style="display: block; margin: 0 auto;" />
<asp:TextBox ID="cedulalog" placeholder="Cédula"  runat="server" 
                 Style="display: block; margin: 0 auto; text-align: center; margin-bottom: 10px;" required type="number"/>
...
<asp:TextBox ID="contralog" placeholder="Contraseña" runat="server" 
                 Style="display: block; margin: 0 auto; text-align: center;" TextMode="Password" required/>
</div>
</div>
